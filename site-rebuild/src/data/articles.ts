...
export const articles: Article[] = [
  {
    ...
    cover: '/assets/editorial/generated/memoria-arquivo.jpg',
    coverAlt: 'Mão organizando cartões em uma gaveta de arquivo, como metáfora para transformar conhecimento individual em memória institucional.',
  ...
  },
  {
    ...
    readingTime: 'Leitura de 9 min',
    cover: '/assets/editorial/sem-vocabulario-comum-a-ia-nao-entende-a-empresa.svg',
    coverAlt: 'Termos diferentes convergindo para uma linguagem comum de negócio.',
  ...
  },
  {
    ...
    readingTime: 'Leitura de 10 min',
    cover: '/assets/editorial/a-ia-que-sabe-quando-parar.svg',
    coverAlt: 'Agente avançando por níveis de autonomia até uma fronteira de aprovação humana.',
  ...
  },
  {
    ...
    readingTime: 'Leitura de 9 min',
    cover: '/assets/editorial/o-modelo-nao-e-o-sistema.svg',
    coverAlt: 'Modelo de linguagem no centro de camadas de regras, ferramentas, memória e observabilidade.',
  ...
  },
  {
    ...
    dateLabel: '25 de novembro de 2025',
    readingTime: 'Leitura de 7 min',
    cover: '/assets/editorial/generated/pix-parcelado-still-life.webp',
    coverAlt: 'Telefone sobre recibos e caderno em uma composição editorial sobre pagamento, crédito e parcelamento.',
  ...
  },
  {
    ...
    readingTime: 'Leitura de 8 min',
    cover: '/assets/editorial/quando-relatorios-viram-sistemas.svg',
    coverAlt: 'Relatório se transformando em um ciclo de decisão, ação, evidência e aprendizado.',
