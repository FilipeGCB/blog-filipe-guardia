...
A integração desta branch é uma **prévia técnica** do PageAgent para o site estático publicado no GitHub Pages.
...
- A versão do PageAgent está fixada em `1.12.2` para evitar mudanças inesperadas.

## Como testar

1. Publique ou visualize a branch.
2. Abra qualquer página que carregue `site-config.js`.
...
O comportamento e o cartão de ativação ficam isolados em `page-agent-loader.js`.
